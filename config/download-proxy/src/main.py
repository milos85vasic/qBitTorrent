...
def start_original_proxy():
    ...
    try:
        ...
        # The original module runs serve_forever when called
        # We'll import and run the main function differently
        sys.path.insert(0, "/config/qBittorrent/nova3/engines")
